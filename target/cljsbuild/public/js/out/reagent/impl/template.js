...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30855__auto__,writer__30856__auto__,opt__30857__auto__){
return cljs.core._write.call(null,writer__30856__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__32151 = o;
(G__32151[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__30232__auto__ = !((jsprops == null));
if(and__30232__auto__){
var and__30232__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__32160 = jsprops;
(G__32160["defaultValue"] = value);

(G__32160["onChange"] = ((function (G__32160,v,value,on_change){
return (function (p1__32157_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32157_SHARP_);
});})(G__32160,v,value,on_change))
);

(G__32160["ref"] = ((function (G__32160,v,value,on_change){
return (function (p1__32158_SHARP_){
return (this$["cljsInputElement"] = p1__32158_SHARP_);
});})(G__32160,v,value,on_change))
);
...
var vec__32167 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32167,(0),null);
var id = cljs.core.nth.call(null,vec__32167,(1),null);
var class$ = cljs.core.nth.call(null,vec__32167,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___32172 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___32172 == null)){
} else {
var key_32173 = temp__4661__auto___32172;
(jsprops["key"] = key_32173);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32175 = (new reagent.impl.template.NativeWrapper());
(G__32175["name"] = c);
...
var len__31357__auto___32181 = arguments.length;
var i__31358__auto___32182 = (0);
while(true){
if((i__31358__auto___32182 < len__31357__auto___32181)){
args__31364__auto__.push((arguments[i__31358__auto___32182]));

var G__32183 = (i__31358__auto___32182 + (1));
i__31358__auto___32182 = G__32183;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31365__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32179){
var G__32180 = cljs.core.first.call(null,seq32179);
var seq32179__$1 = cljs.core.next.call(null,seq32179);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32180,seq32179__$1);
});
...
break;
default:
var G__32187 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__32187;
continue;
...
var n__31167__auto___32190 = a.length;
var i_32191 = (0);
while(true){
if((i_32191 < n__31167__auto___32190)){
(a[i_32191] = reagent.impl.template.as_element.call(null,(a[i_32191])));

var G__32192 = (i_32191 + (1));
i_32191 = G__32192;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31167__auto___32193 = a.length;
var i_32194 = (0);
while(true){
if((i_32194 < n__31167__auto___32193)){
var val_32195 = (a[i_32194]);
if((cljs.core.vector_QMARK_.call(null,val_32195)) && ((reagent.impl.template.key_from_vec.call(null,val_32195) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32194] = reagent.impl.template.as_element.call(null,val_32195));

var G__32196 = (i_32194 + (1));
i_32194 = G__32196;
continue;
} else {
}
...
var ctx = ({});
var vec__32200 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__32200,(0),null);
var derefed = cljs.core.nth.call(null,vec__32200,(1),null);
...
var G__32204 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32204) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32204){
